...
"subscriber" property matches with the name (or _id) of the user and the count of those docs will be exactly the number of channels the user has subscribed to. Basically, the count of those docs in the collection using "channel" prop will give us "no. of subscribers", whereas counting docs using "subscriber" prop will give us "no. of channels the user has subscribed to". A new document is created and added to the "subscriptions" collection whenever any user or channel subscribed to a different user/channel, as well as a document gets deleted from this collection whenever a subscription gets cancelled. */
