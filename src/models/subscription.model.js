...
"subscriber" property matches with the name (or _id) of the user and the count of those docs will be exactly the number of channels the user has subscribed to. */
